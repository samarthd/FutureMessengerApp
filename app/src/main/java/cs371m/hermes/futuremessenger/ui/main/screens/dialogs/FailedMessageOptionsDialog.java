...
public class FailedMessageOptionsDialog extends MessageOptionsDialog {

    public FailedMessageOptionsDialog() {
        // empty constructor
    }
    ...
    protected View inflateAndReturnDialogLayout(LayoutInflater inflater) {
        View dialogLayout =
                inflater.inflate(R.layout.options_dialog_failed_message, null);
